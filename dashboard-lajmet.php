            ...
            <div style="width: 1920px; height: 100vh; display: flex; flex-direction:row;">
                ...
                <div class="dashboard-windows">
                    <div style="align-self: flex-start; display: flex; flex-direction:column; justify-content:center; align-items:center;">
                        ...
                        <h1 style="color:white; font-family:Britanica;">Shto lajm të ri</h1>
                        <a href="insert-lajm.php"><button class="button-signup" style="width: 400px; margin-bottom: 20px;">Regjistro</button></a>

                        <hr style="width:1200px;">
                        
                        <p style="color:white; font-family:Britanica; font-size: 20pt;">Lista e lajmeve:</p>
                            
                        <table style="width: 1200px; text-align:left;">
                            <tr style="background-color: gray;">
                                <th style="color:white; font-family:Britanica; font-size: 28px; border-bottom: 2px white; width: 60%">Titulli</th>
                                <th style="color:white; font-family:Britanica; font-size: 28px; width: 15%">Autori</th>
                                <th style="color:white; font-family:Britanica; text-align: right; font-size: 28px; width: 25%">Editimi</th>
                            </tr>
                            ...
                            <?php
                                ...
                                <tr>
                                <td style="color:white; font-family:Britanica; font-size: 28px;"><?php echo $rows['lajmi_titull'];?> </td>
                                <td style="color:white; font-family:Britanica; font-size: 28px;"><?php echo $rows['autori'];?> </td>
                                <td style="color:white; font-family:Britanica; text-align: right; font-size: 28px;">
                                    <a href="edit-lajm.php?id=<?php echo $rows['lajmi_id']?>"><button class="button-signup" style="width: 45%;" >Redakto</button></a>
                                    <a href="delete-lajm.php?id=<?php echo $rows['lajmi_id']?>" style="font-size: 0px;">"<button class="button-signup" style="width: 45%;" >Fshij</button></a>
                                </td>
                                </tr>
                                <?php }                                
                            ?>
